...
import _thread
import logging
from nascan.lib.common import *
from nascan.lib.start import *

if __name__ == "__main__":
    try:
        CONFIG_INI = get_config()  # 读取配置
        log.write('info', None, 0, '获取配置成功')
